...
public class ImageActivity extends AppCompatActivity implements ImageAdapter.OnItemClickListener {
    ...
    public void onItemClick(int position) {
        Toast.makeText(ImageActivity.this, "Normal click at position: " + position, Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onWhatEverClick(int position) {
        Toast.makeText(ImageActivity.this, "Whatever click at position: " + position, Toast.LENGTH_SHORT).show();
    }
...
//            public void onDataChange( DataSnapshot dataSnapshot) {
//
//                mUploads.clear(); //commit6 in video8 because of a error
//
//                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
//                    Upload upload = postSnapshot.getValue(Upload.class);
//                    upload.setKey(postSnapshot.getKey());
...
//                }
//
//                //changed in video 8 on commit 6
//                mAdapter.notifyDataSetChanged();
//
//                mProgressCircle.setVisibility(View.INVISIBLE);
//            }
...
//            public void onSuccess(Void aVoid) {
//                mDatabaseRef.child(selectedKey).removeValue();
//                Toast.makeText(ImageActivity.this, "Item Deleted.", LENGTH_SHORT).show();
//            }
//        });
//    }
//
